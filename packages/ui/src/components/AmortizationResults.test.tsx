...
describe('AmortizationResults', () => {
    ...
    schedule: [
      {
        ...
        interest: 56.07,
        balance: 9200,
        cumulativeInterest: 56.07,
        cumulativePrincipal: 800,
      },
      {
        month: 2,
        payment: 856.07,
        ...
        interest: 51.4,
        balance: 8395.33,
        cumulativeInterest: 107.47,
        cumulativePrincipal: 1604.67,
      },
      {
        month: 3,
        payment: 856.07,
        ...
        interest: 46.68,
        balance: 7585.94,
        cumulativeInterest: 154.15,
        cumulativePrincipal: 2414.06,
      },
      {
        month: 4,
        payment: 856.07,
        ...
        interest: 41.93,
        balance: 6771.8,
        cumulativeInterest: 196.08,
        cumulativePrincipal: 3228.2,
      },
      {
        month: 5,
        payment: 856.07,
        ...
        interest: 37.13,
        balance: 5952.86,
        cumulativeInterest: 233.21,
        cumulativePrincipal: 4047.14,
      },
      {
        month: 6,
        payment: 856.07,
        ...
        interest: 32.29,
        balance: 5129.08,
        cumulativeInterest: 265.5,
        cumulativePrincipal: 4870.92,
      },
      {
        month: 7,
        payment: 856.07,
        ...
        interest: 27.41,
        balance: 4300.42,
        cumulativeInterest: 292.91,
        cumulativePrincipal: 5699.58,
      },
      {
        month: 8,
        payment: 856.07,
        ...
        interest: 22.49,
        balance: 3466.84,
        cumulativeInterest: 315.4,
        cumulativePrincipal: 6533.16,
      },
      {
        month: 9,
        payment: 856.07,
        ...
        interest: 17.53,
        balance: 2628.3,
        cumulativeInterest: 332.93,
        cumulativePrincipal: 7371.7,
      },
      {
        month: 10,
        payment: 856.07,
        ...
        interest: 12.53,
        balance: 1784.76,
        cumulativeInterest: 345.46,
        cumulativePrincipal: 8215.24,
      },
      {
        month: 11,
        payment: 856.07,
        ...
        interest: 7.48,
        balance: 936.17,
        cumulativeInterest: 352.94,
        cumulativePrincipal: 9063.83,
      },
      {
        month: 12,
        payment: 856.07,
  ...
  it('displays extra payment benefits when present', () => {
    ...
    expect(
      within(extraPaymentsCard as HTMLDivElement).getByText(/\$400(\.00)?/)
    ).toBeInTheDocument();
