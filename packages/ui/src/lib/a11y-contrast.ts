...
export const REQUIRED_CONTRAST_PAIRS = [
  ...
  { name: 'secondary copy on dark shell', foreground: '#94a3b8', background: '#050816' },
  { name: 'body copy on white', foreground: '#475569', background: '#ffffff' },
  { name: 'help copy on white', foreground: '#475569', background: '#ffffff' },
