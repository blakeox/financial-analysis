...
describe('Performance', () => {
  ...
  describe('Comprehensive Analysis', () => {
    it('should return a complete analysis object with all required fields', () => {
      ...
      expect(result).toHaveProperty('timeValue');
      ...
      expect(result).toHaveProperty('probabilityITM');
      expect(result).toHaveProperty('probabilityOTM');
      ...
      // Time Decay
      expect(result).toHaveProperty('thetaDecay');
      expect(Array.isArray(result.thetaDecay)).toBe(true);

      // Moneyness
      expect(result).toHaveProperty('moneyness');
      expect(result.moneyness).toHaveProperty('spot');
      expect(result.moneyness).toHaveProperty('percentMoneyness');
    });
  });
});
