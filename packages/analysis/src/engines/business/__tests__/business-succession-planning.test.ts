...
describe('BusinessSuccessionPlanningCalculator', () => {
  ...
  it('should return all required fields in the analysis result', () => {
    ...
    expect(result).toHaveProperty('valuationAnalysis');
    expect(result).toHaveProperty('taxAnalysis');
    expect(result).toHaveProperty('estateTaxImpact');
    expect(result).toHaveProperty('transferStrategies');
    expect(result).toHaveProperty('timingAnalysis');
    expect(result).toHaveProperty('fundingAnalysis');
