...
describe('FinancialRatioAnalyzer', () => {
  ...
  describe('Comprehensive Analysis', () => {
    it('should return all required fields in the analysis result', () => {
      ...
      expect(result).toHaveProperty('liquidityRatios');
      expect(result).toHaveProperty('profitabilityRatios');
      expect(result).toHaveProperty('efficiencyRatios');
      expect(result).toHaveProperty('leverageRatios');
      expect(result).toHaveProperty('marketRatios');
