...
describe('CapitalStructureOptimizer', () => {
  ...
  describe('Comprehensive Analysis', () => {
    it('should return all required fields in the analysis result', () => {
      const result = CapitalStructureOptimizer.analyze(baseInput) as any;

      expect(result).toHaveProperty('currentStructure');
      expect(result).toHaveProperty('wacc');
      expect(result).toHaveProperty('waccOptimization');
      expect(result).toHaveProperty('debtCapacity');
      expect(result).toHaveProperty('creditRatingImpact');
      expect(result).toHaveProperty('optimalStructure');
