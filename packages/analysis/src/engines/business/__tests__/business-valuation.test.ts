...
describe('BusinessValuationEngine', () => {
  ...
  describe('Comprehensive Analysis', () => {
    it('returns all required fields in the result object', () => {
      ...
      expect(result).toHaveProperty('valuationLow');
      expect(result).toHaveProperty('valuationMid');
      expect(result).toHaveProperty('valuationHigh');
      expect(result).toHaveProperty('methods');
      expect(result).toHaveProperty('ebitdaMultiple');
      expect(result).toHaveProperty('revenueMultiple');
      expect(result).toHaveProperty('sdeMultiple');
      expect(result).toHaveProperty('bookValue');
      expect(result).toHaveProperty('adjustedBookValue');
      // valuePerCustomer is optional
      expect(result).toHaveProperty('valuePerDollarRevenue');
