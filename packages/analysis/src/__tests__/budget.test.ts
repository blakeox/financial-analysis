...
describe("BudgetEngine", () => {
  it("should analyze basic budget", () => {
    const input: BudgetInput = {
      income: [
        { name: "Salary", monthlyAmount: 5000, type: "salary", recurring: true },
      ],
      expenses: [
        ...
        { name: "Entertainment", monthlyAmount: 300, type: "entertainment", isFixed: false, isEssential: false },
      ],
      debts: [],
  ...
  it("should calculate 50/30/20 budget rule", () => {
    const input: BudgetInput = {
      ...
      expenses: [
        ...
        { name: "Utilities", monthlyAmount: 200, type: "utilities", isFixed: false, isEssential: true },
        { name: "Food", monthlyAmount: 600, type: "food", isFixed: false, isEssential: true },
        { name: "Entertainment", monthlyAmount: 500, type: "entertainment", isFixed: false, isEssential: false },
        { name: "Shopping", monthlyAmount: 400, type: "personal", isFixed: false, isEssential: false },
      ],
      debts: [],
  ...
  it("should analyze debt-to-income ratio", () => {
    const input: BudgetInput = {
      income: [
        { name: "Salary", monthlyAmount: 8000, type: "salary", recurring: true },
      ],
      expenses: [
      ...
      debts: [
        { name: "Mortgage", totalBalance: 300000, monthlyPayment: 1800, interestRate: 0.04, type: "mortgage" },
        { name: "Auto Loan", totalBalance: 20000, monthlyPayment: 400, interestRate: 0.06, type: "auto" },
        { name: "Credit Card", totalBalance: 5000, monthlyPayment: 150, interestRate: 0.18, type: "credit_card" },
      ],
  ...
  it("should identify overspending categories", () => {
    const input: BudgetInput = {
      income: [
        { name: "Salary", monthlyAmount: 4000, type: "salary", recurring: true },
      ],
      expenses: [
        ...
        { name: "Entertainment", monthlyAmount: 600, type: "entertainment", isFixed: false, isEssential: false },
      ],
      debts: [],
  ...
  it("should generate optimized budget", () => {
    const input: BudgetInput = {
      income: [
        { name: "Salary", monthlyAmount: 7000, type: "salary", recurring: true },
      ],
      expenses: [
        { name: "Housing", monthlyAmount: 2000, type: "housing", isFixed: true, isEssential: true },
        { name: "Food", monthlyAmount: 700, type: "food", isFixed: false, isEssential: true },
        { name: "Entertainment", monthlyAmount: 800, type: "entertainment", isFixed: false, isEssential: false },
        { name: "Shopping", monthlyAmount: 600, type: "personal", isFixed: false, isEssential: false },
        { name: "Dining Out", monthlyAmount: 500, type: "food", isFixed: false, isEssential: false },
      ],
      debts: [],
      savingsGoalMonthly: 1000,
      optimizationGoal: "maximize_savings",
  ...
  it("should calculate financial health score", () => {
    const input: BudgetInput = {
      ...
      expenses: [
        ...
        { name: "Transportation", monthlyAmount: 400, type: "transportation", isFixed: false, isEssential: true },
        { name: "Food", monthlyAmount: 600, type: "food", isFixed: false, isEssential: true },
        { name: "Utilities", monthlyAmount: 200, type: "utilities", isFixed: false, isEssential: true },
        { name: "Entertainment", monthlyAmount: 300, type: "entertainment", isFixed: false, isEssential: false },
      ],
      debts: [
        { name: "Student Loan", totalBalance: 30000, monthlyPayment: 350, interestRate: 0.05, type: "student" },
      ],
  ...
  it("should provide comprehensive recommendations", () => {
    const input: BudgetInput = {
      ...
      debts: [
        { name: "Credit Card", totalBalance: 8000, monthlyPayment: 250, interestRate: 0.19, type: "credit_card" },
      ],
      savingsGoalMonthly: 500,
      optimizationGoal: "balance",
    };
