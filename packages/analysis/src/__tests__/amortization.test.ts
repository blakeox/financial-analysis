...
function createAmortizationInput(
  overrides: Partial<Parameters<typeof AmortizationAnalyzer.analyze>[0]> = {}
) {
  return {
    principal: 100000,
    annualRate: 0.06,
  ...
  describe('analyze', () => {
    describe('basic amortization calculations', () => {
      it('should calculate basic monthly payment correctly', () => {
        ...
        expect(result.totalPayments).toBe(215838.0);
    ...
    describe('extra monthly payments', () => {
      it('should handle extra monthly payments and calculate savings', () => {
        const standardResult = AmortizationAnalyzer.analyze(
          createAmortizationInput({
            principal: 200000,
            annualRate: 0.045,
            termMonths: 360,
        ...
        const extraPaymentResult = AmortizationAnalyzer.analyze(
          createAmortizationInput({
            principal: 200000,
            annualRate: 0.045,
            termMonths: 360,
    ...
    describe('payment frequencies', () => {
      it('should handle biweekly payments', () => {
        const monthlyResult = AmortizationAnalyzer.analyze(
          createAmortizationInput({
            paymentFrequency: 'monthly',
          })
        );

        const biweeklyResult = AmortizationAnalyzer.analyze(
          createAmortizationInput({
    ...
    describe('fees and points', () => {
      it('should adjust principal for origination fees', () => {
        ...
        const feeResult = AmortizationAnalyzer.analyze(
          createAmortizationInput({
      ...
      it('should adjust principal for discount points', () => {
        ...
        const pointsResult = AmortizationAnalyzer.analyze(
          createAmortizationInput({
...
describe('buildAmortizationComprehensiveAnalysis', () => {
  ...
  it('includes extra payment insights when schedule has contributions', () => {
    ...
    expect(narrative.insights.some((item) => item.title.includes('Extra Payment'))).toBe(true);
  });
});
