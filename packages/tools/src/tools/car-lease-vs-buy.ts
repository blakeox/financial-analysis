      ...
      leaseTerms: {
        ...
        properties: {
          ...
          residualPercentage: {
            ...
            maximum: 1,
            default: 0.5,
            description: 'Residual percentage',
          },
          mileageAllowance: {
            type: 'number',
            minimum: 0,
          ...
          excessMileageFee: {
            ...
            minimum: 0,
            default: 0.25,
            description: 'Excess mileage fee per mile',
          },
        },
      ...
      ownershipCosts: {
        ...
        properties: {
          ...
          expectedOwnershipYears: {
            ...
            maximum: 20,
            default: 6,
            description: 'Expected ownership years',
          },
        },
      ...
      financialAssumptions: {
        ...
        properties: {
          opportunityCostRate: {
            ...
            maximum: 0.2,
            default: 0.07,
            description: 'Opportunity cost rate',
          },
      ...
      analysis: {
        ...
        properties: {
          ...
          includeTaxBenefits: {
            type: 'boolean',
            default: true,
            description: 'Include tax benefits',
          },
          includeEarlyTermination: {
            type: 'boolean',
            default: false,
            description: 'Include early termination analysis',
          },
        },
      },
    },
