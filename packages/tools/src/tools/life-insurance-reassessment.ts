    ...
    properties: {
      ...
      currentPolicies: {
        ...
        items: {
          ...
          properties: {
            policyType: {
              type: 'string',
              enum: ['term', 'whole-life', 'universal-life', 'variable-life'],
          ...
          incomeReplacement: {
            ...
            properties: {
              yearsOfIncome: {
                ...
                minimum: 0,
                default: 10,
                description: 'Years of income to replace',
              },
              replacementPercentage: {
                ...
                maximum: 1,
                default: 0.7,
                description: 'Replacement percentage',
              },
            },
          },
          debtPayoff: {
          ...
          educationFunding: {
            ...
            properties: {
              ...
              educationCostPerChild: {
                ...
                minimum: 0,
                default: 0,
                description: 'Education cost per child',
              },
            },
          },
          finalExpenses: {
      ...
      analysis: {
        ...
        properties: {
          ...
          includePolicyOptimization: {
            type: 'boolean',
            default: true,
            description: 'Include policy optimization',
          },
          ...
          includeTermVsPermanent: {
            type: 'boolean',
            default: true,
            description: 'Include term vs permanent comparison',
          },
        },
      },
    },
