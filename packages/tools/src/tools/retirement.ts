  ...
  static inputSchema = {
    ...
    properties: {
      ...
      accounts: {
        ...
        items: {
          ...
          properties: {
            ...
            employerMatchLimit: {
              type: "number",
              description: "Max employee contribution for match as decimal (e.g., 0.06 for 6%, default 0.06)",
              minimum: 0,
              maximum: 1,
              default: 0.06,
            },
      ...
      desiredRetirementIncome: {
        type: "number",
        description: "Desired annual retirement income in dollars (optional, calculates from 4% rule if not provided)",
        minimum: 1,
        maximum: 100_000_000,
      },
      withdrawalStrategy: {
