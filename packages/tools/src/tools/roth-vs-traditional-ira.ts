    ...
    properties: {
      personalInfo: {
        ...
        properties: {
          ...
          currentTaxBracket: {
            ...
            minimum: 0,
            maximum: 0.5,
            description: 'Current tax bracket',
          },
          expectedRetirementTaxBracket: {
            type: 'number',
            minimum: 0,
            maximum: 0.5,
            description: 'Expected retirement tax bracket',
          },
        },
      ...
      contributionDetails: {
        ...
        properties: {
          ...
          yearsToContribute: {
            ...
            minimum: 1,
            maximum: 50,
            description: 'Years to contribute',
          },
        },
      ...
      accountDetails: {
        ...
        properties: {
          currentTraditionalBalance: {
            ...
            minimum: 0,
            default: 0,
            description: 'Current Traditional IRA balance',
          },
          currentRothBalance: {
            type: 'number',
            minimum: 0,
            default: 0,
            description: 'Current Roth IRA balance',
          },
          expectedReturn: {
            type: 'number',
            minimum: 0,
      ...
      taxInfo: {
        ...
        properties: {
          ...
          expectedRetirementMarginalTaxRate: {
            type: 'number',
            minimum: 0,
            maximum: 0.5,
            description: 'Expected retirement marginal tax rate',
          },
          stateTaxRate: {
            type: 'number',
            minimum: 0,
          ...
          stateTaxDeduction: {
            type: 'boolean',
            default: false,
            description: 'State tax deduction available',
          },
        },
      ...
      withdrawalStrategy: {
        ...
        properties: {
          annualWithdrawalAmount: {
            ...
            minimum: 0,
            default: 0,
            description: 'Annual withdrawal amount',
          },
          withdrawalStartAge: {
            type: 'number',
            minimum: 59.5,
            maximum: 100,
            description: 'Withdrawal start age',
          },
          includeRequiredMinimumDistributions: {
            type: 'boolean',
            default: true,
            description: 'Include RMDs',
          },
          rmdsStartAge: {
            type: 'number',
            minimum: 72,
      ...
      analysis: {
        type: 'object',
        properties: {
          includeConversionAnalysis: {
            type: 'boolean',
            default: true,
            description: 'Include conversion analysis',
          },
          includeTaxBracketOptimization: {
            type: 'boolean',
            default: true,
