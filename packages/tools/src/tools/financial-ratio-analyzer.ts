  ...
  static readonly inputSchema = {
    ...
    properties: {
      ...
      analysis: {
        type: 'object',
        properties: {
          includeLiquidityRatios: {
            type: 'boolean',
            default: true,
            description: 'Include liquidity ratios',
          },
          includeProfitabilityRatios: {
            type: 'boolean',
            default: true,
            description: 'Include profitability ratios',
          },
          includeEfficiencyRatios: {
            type: 'boolean',
            default: true,
            description: 'Include efficiency ratios',
          },
          includeLeverageRatios: {
            type: 'boolean',
            default: true,
            description: 'Include leverage ratios',
          },
          includeMarketRatios: {
            type: 'boolean',
            default: true,
            description: 'Include market ratios',
          },
          includeBenchmarking: {
            type: 'boolean',
            default: true,
            description: 'Include benchmarking',
          },
        },
      },
    },
