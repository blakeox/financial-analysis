...
export function estimateTokensCombined(
  ...
  const responseTokens =
    typeof response === 'string' ? estimateTokens(response) : estimateTokensFromJSON(response);
 ...
 */
export function estimateCost(model: string, promptTokens: number, responseTokens: number): number {
