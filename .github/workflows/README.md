...
| [mcp-policy.yml](./mcp-policy.yml)                         | Every PR + push to `main`/`dev`                                                 | **MCP policy** — focused OAuth, OIDC, capability, tenant-isolation, lifecycle, and interoperability checks; skips install for unrelated paths |
