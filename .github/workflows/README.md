...
| [cloudflare-waf-audit.yml](./cloudflare-waf-audit.yml)                   | Daily + manual         | Read-only Cloudflare WAF inventory, custom-WAF baseline gate, receipt, and issue alert; must be on the default branch for hosted dispatch |
