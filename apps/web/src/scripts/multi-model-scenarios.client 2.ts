  ...
  private initializeScenarios(): void {
    const scenarios: FinancialScenario[] = [
      ...
      },
      {
        ...
        description:
          'Comprehensive journey for businesses considering expansion loans with debt capacity, DSCR, cash flow projections, and risk assessment',
        category: 'business',
        models: [
          {
            id: 'business-expansion-loan',
            name: 'Business Expansion Loan Analysis',
            description:
              'Complete expansion loan analysis with debt capacity, DSCR, and cash flow projections',
          ...
          },
          {
            ...
            description: 'Analyze cash flow impact of expansion loan',
          ...
          },
          {
            ...
            description: 'Project EBITDA improvements from expansion',
            url: '/calculator/ebitda-forecasting',
            order: 3,
            required: false,
          },
        ],
        workflow: [
          ...
          'Project cash flow with loan payments',
          'Analyze DSCR and risk factors',
          'Compare loan scenarios and terms',
          'Get recommendations and finalize decision',
        ],
        estimatedDuration: '2-3 hours',
        complexity: 'intermediate',
      },
