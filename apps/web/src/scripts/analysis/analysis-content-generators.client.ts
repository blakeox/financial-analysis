        ...
        <div class="fa-subcard p-4">
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <p class="text-sm fa-meta-copy mb-2">${insight.description}</p>
            </div>
        ...
        <div class="fa-subcard p-4">
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <p class="text-sm fa-meta-copy mb-3">${rec.description}</p>
      ...
      <div class="flex items-start justify-between">
        <div class="flex-1">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="text-sm">
              <span class="fa-help-copy">Savings:</span>
