...
async function handleCalculate(form: HTMLFormElement, calculateBtn: HTMLElement | null) {
  setLoadingState(calculateBtn as HTMLButtonElement | null, true);
  if (calculateBtn instanceof HTMLButtonElement) {
    calculateBtn.textContent = '📊 Calculating...'; // Custom text with emoji
  }
  ...
  try {
    ...
    if (cached) {
      ...
      hideLoading();
      setLoadingState(calculateBtn as HTMLButtonElement | null, false);
      if (calculateBtn instanceof HTMLButtonElement) {
