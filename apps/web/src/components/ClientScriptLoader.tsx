...
type ScriptLoaderMap = {
  ...
  'social-security': () => Promise<unknown>;
  heloc: () => Promise<unknown>;
  refinancing: () => Promise<unknown>;
  'capital-structure': () => Promise<unknown>;
  'project-finance': () => Promise<unknown>;
  'real-estate-investment': () => Promise<unknown>;
  'fire-calculator': () => Promise<unknown>;
  lbo: () => Promise<unknown>;
  'credit-risk': () => Promise<unknown>;
  'working-capital': () => Promise<unknown>;
  var: () => Promise<unknown>;
  'portfolio-optimization': () => Promise<unknown>;
  'estate-planning': () => Promise<unknown>;
  'emergency-fund': () => Promise<unknown>;
  'net-worth': () => Promise<unknown>;
  '401k-match': () => Promise<unknown>;
...
const scriptLoaders: ScriptLoaderMap = {
  ...
  'social-security': () => import('../scripts/calculators/social-security.client.ts'),
  heloc: () => import('../scripts/calculators/heloc.client.ts'),
  refinancing: () => import('../scripts/calculators/refinancing.client.ts'),
  'capital-structure': () => import('../scripts/business/capital-structure.client.ts'),
  'project-finance': () => import('../scripts/business/project-finance.client.ts'),
  'real-estate-investment': () => import('../scripts/business/real-estate-investment.client.ts'),
  'fire-calculator': () => import('../scripts/calculators/fire-calculator.client.ts'),
  lbo: () => import('../scripts/business/lbo.client.ts'),
  'credit-risk': () => import('../scripts/business/credit-risk.client.ts'),
  'working-capital': () => import('../scripts/business/working-capital.client.ts'),
  var: () => import('../scripts/business/var.client.ts'),
  'portfolio-optimization': () => import('../scripts/business/portfolio-optimization.client.ts'),
  'estate-planning': () => import('../scripts/calculators/estate-planning.client.ts'),
  'emergency-fund': () => import('../scripts/calculators/emergency-fund.client.ts'),
  'net-worth': () => import('../scripts/calculators/net-worth.client.ts'),
  '401k-match': () => import('../scripts/calculators/401k-match.client.ts'),
