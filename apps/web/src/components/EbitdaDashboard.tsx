      ...
      {!state.results && (
        <>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Setup Progress</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className={`text-center p-3 rounded-lg border ${
                ...
                <div className={`text-2xl mb-2 ${
                  Object.values(state.financials).some(v => (v || 0) > 0) ? 'text-green-600' : 'text-gray-400'
                }`}>💰</div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-blue-200 dark:border-blue-700">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-left">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">Revenue Data</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">Enter monthly revenue</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">Add Employees</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">Salary & billable hours</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">Expense Types</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">Monthly amounts</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">Scenario settings</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
