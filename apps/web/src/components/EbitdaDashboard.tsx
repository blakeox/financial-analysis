...
export function EbitdaDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card
        variant="rail"
        className="bg-linear-to-r from-violet-50/90 to-emerald-50/80 dark:from-violet-950/30 dark:to-emerald-950/20"
      >
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <h2 className="fa-panel-title text-3xl">EBITDA Forecasting Dashboard</h2>
              </div>
              ...
              <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
                {(() => {
                  ...
                  const monthlyDepreciation = state.fixedAssets
                    .filter((a) => a.isActive)
                    .reduce((s, a) => s + (a.monthlyDepreciation || 0), 0);
                  const monthlyLeasePayments = state.leases
                    .filter((l) => l.isActive)
                    .reduce((s, l) => s + (l.monthlyPayment || 0), 0);
                  const monthlyOpExBaseline =
                    state.expenseTypes
                      .filter((e) => e.isActive)
                      .reduce((s, e) => s + (e.currentMonthlyAmount || 0), 0) +
                    monthlyLeasePayments;
                  ...
                  return (
                    <>
                      <div className={chipBase}>
                        <span className="fa-help-copy uppercase tracking-wide">
                          Active Employees
                        </span>
                      ...
                      <div className={chipBase}>
                        ...
                        <span className="fa-metric-value-secondary">
                          {format(monthlyLeasePayments)}
                        </span>
                      </div>
                      <div className={chipBase}>
                        <span className="fa-help-copy uppercase tracking-wide">
                        ...
                        <span className="fa-metric-value-accent">
                          {format(monthlyOpExBaseline)}
                        </span>
                      </div>
                    </>
                  );
      ...
      {state.error && (
        <Card
          variant="subtle"
          className="border-rose-200 bg-rose-50/90 dark:border-rose-900/70 dark:bg-rose-950/30"
        >
          <CardContent className="p-6">
      ...
      {!state.results && (
        <>
          ...
          <Card variant="subtle" className="p-6">
            <h3 className="fa-scenario-title mb-4">Setup Progress</h3>
              ...
              <div className="fa-subcard p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-left">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <div className="fa-scenario-title">Revenue Data</div>
                      <div className="fa-meta-copy text-sm">Enter monthly revenue</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-violet-600 text-sm font-bold text-white">
                    ...
                    <div>
                      <div className="fa-scenario-title">Add Employees</div>
                      <div className="fa-meta-copy text-sm">Salary & billable hours</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-violet-600 text-sm font-bold text-white">
                    ...
                    <div>
                      <div className="fa-scenario-title">Expense Types</div>
                      <div className="fa-meta-copy text-sm">Monthly amounts</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-violet-600 text-sm font-bold text-white">
                    ...
                    <div>
                      ...
                      <div className="fa-meta-copy text-sm">Scenario settings</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
