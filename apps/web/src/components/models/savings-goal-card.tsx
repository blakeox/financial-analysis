...
export function SavingsGoalCard({ className = '' }: ModelCardProps) {
  return (
    <a href="/models/personal-finance/savings-goal" className={`block group ${className}`}>
      <div className={getModelCardShellClass('teal')}>
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="fa-model-title text-xl">Savings Goal Planner</h3>
        </div>
        <p className="fa-model-description mb-4 text-sm">
          Plan and track progress toward financial goals with compound interest calculations,
          inflation adjustments, and alternative scenarios.
        </p>
