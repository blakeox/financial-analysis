...
export function RetirementCard({ className = '' }: ModelCardProps) {
  return (
    <a href="/models/personal-finance/retirement" className={`block group ${className}`}>
      <div className={getModelCardShellClass('violet')}>
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="fa-model-title text-xl">Retirement Calculator</h3>
        </div>
        <p className="fa-model-description mb-4 text-sm">
          Project retirement savings across multiple accounts (401k, IRA, Roth) with employer match
          optimization, tax advantages, and withdrawal strategies.
        </p>
